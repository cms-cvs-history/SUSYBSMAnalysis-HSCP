root -l -b << EOF
  ...
  //.x Analysis_Step23.C++("ANALYSE_SIGNAL", 0, "dedxASmi", "dedxHarm2", "combined", 0, 0, 0, 45.0, 2.1);
  .x Analysis_Step23.C++("ANALYSE_DATA", 2, "dedxASmi", "dedxHarm2", "combined", 0.0, 0.0, 0.0, 50.0, 2.1);
