root -l -b << EOF
  ...
  .x Analysis_Step234.C++("ANALYSE_SIGNAL_PUSyst", 2, "dedxASmi", "dedxHarm2", "combined", 0, 0, 0, 45.0, 2.1);
  //.x Analysis_Step234.C++("ANALYSE_MC", 2, "dedxASmi", "dedxHarm2", "combined", 0, 0, 0, 45.0, 2.1);
